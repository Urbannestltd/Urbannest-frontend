        ...
        <SectionBox bg={"#FFFFFF"} mt={8} pt={0} px={0}>
            <Tabs.Root defaultValue={'activity'}>
                <Tabs.List alignContent={'center'} color={''} borderBottom={'1px solid #A9B4B91A'}>
                    <Tabs.Trigger justifyContent={'center'} w={'full'} px={{ base: '12px', md: '32px' }} py={'30px'} _selected={{ fontWeight: 700 }} className="satoshi-bold" value={'activity'}>Activity Timeline</Tabs.Trigger>
