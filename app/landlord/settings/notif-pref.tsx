...
import { CustomCheckbox } from "@/components/ui/custom-fields"
import { Divider } from "@/components/ui/divider"
import { PageTitle } from "@/components/ui/page-title"
import { getNotifPreferences, LandlordNotificationPreferences, updateNotifPreferences } from "@/services/landlord/settings"
...
export const NotifPref = () => {
    const [notifValues, setNotifValues] = useState<LandlordNotificationPreferences>()
    ...
    const { control, handleSubmit } = useForm<LandlordNotificationPreferences>({ defaultValues: notifValues })

    const mutation = useMutation({
        mutationFn: (payload: LandlordNotificationPreferences) => updateNotifPreferences(payload),
        onSuccess: () => {
    ...
    const onSubmit = async (data: LandlordNotificationPreferences) => {
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <Flex justify={'space-between'}>
                    ...
                    <Stack>
                        ...
                        <CustomCheckbox name='emailTenantApprovals' control={control} onChange={submitForm}
                            value={notifValues?.emailTenantApprovals} options={options[3]} />
                    </Stack>
                </Flex>
            </form>
        </Box>
...
const options = [
    {
        label: 'Payments',
        description: 'Get emails about rent payments, revenue updates, and overdue payments.'
    },
    {
        label: 'Lease',
    ...
    },
    {
        ...
        description: 'Get emails when new tenant applications are forwarded or decided.'
    }
]
