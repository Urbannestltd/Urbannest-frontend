...
import { createTicket, createTicketPayload } from "@/services/landlord/settings"
        ...
        <Box p={4}>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <Stack gap={4}>
                    ...
                    <MainButton loading={mutation.isPending} loadingText="Submitting" onClick={handleSubmit(onSubmit)} type="submit" className="h-[37px]" size='sm'>Submit</MainButton>
                </Stack>
            </form>
        </Box>
    )
