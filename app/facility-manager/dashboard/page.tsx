...
export default function Dashboard() {
    ...
    const {
        ...
        isLoadingTickets,
        errorLoadingSummary,
        errorLoadingVisitors,
        errorLoadingTickets,
    } = useFMDashboardStore((state) => state)
            ...
            >
                <Box w={{ base: "full", md: "50%" }}>
                    ...
                    {isMobile ? (
                        ...
                        <Box rounded={4} mt={"30px"} p={0}>
                            <DataTable
                                bgColor="white"
                                my={"0px"}
                                miniTableOnclick={() =>
                                    router.push("/facility-manager/maintenance-and-issues")
                                }
                                onRowClick={(row) =>
                                    router.push(
                                        `/facility-manager/maintenance-and-issues/${row.id}`,
                                    )
                                }
                                rounded
                                headerColor="#000000"
                        ...
                        <Tabs.Content value="walk-in">
                            {isMobile ? (
                                <MobileTableVisitor
                                    ...
                                    tableName="visitors"
                                    emptyDetails={{
                                        icon: emptyVisitorIcon.src,
                                        title: "No visitors today",
                                        description:
                                            "Visitors your tenants add will appear here for easy access and entry tracking.",
                                    }}
                                />
                            ) : (
                                <Box mt={{ base: "10px", md: "0px" }} p={0}>
                                    <DataTable
                                        ...
                                        borderRadius={"11px"}
                                        miniTableOnclick={() =>
                                            router.push("/facility-manager/visitor-management")
                                        }
                                        rounded
